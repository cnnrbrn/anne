export function createImageElement({ id = '', className = '', src = '', alt = ''}) {
...
export function createHeadingElement({ id = '', className = '', htmlElement, textContent}) {
...
export function createElementParagraph({id= '', className = '', textContent}) {
